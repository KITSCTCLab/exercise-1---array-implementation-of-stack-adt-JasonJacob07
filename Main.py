...
class Stack:
   ''' Creation of a class called Stack
   This class includes all the necessary stack operations
   This class contains 6 necessary function for the Operation of stack
   First, to intialize size of the stack with the Stack class(max size of the stack)
